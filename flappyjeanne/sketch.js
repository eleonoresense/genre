...
function setup() {
  ...
  birdImg = loadImage('assets/tete.png');
  pipeImg = loadImage('assets/tuyaudeux.png') ;
  groundImg = loadImage('assets/vachetrois.png');
  bgImg = loadImage('assets/fondquatre.png');
...
function draw() {
  ...
  background(121, 0, 255);
  camera.off();
  image(bgImg, 0, GROUND_Y-220);
  camera.on();
